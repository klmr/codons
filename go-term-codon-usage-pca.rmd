...
mins = min(log_sizes)
maxs = max(log_sizes)
size_colors = colorRampPalette(c('#0000FF80', '#80000080'),
                               bias = 100, alpha = TRUE)(maxs - mins + 1)
pc_plot(pc, col = size_colors[log_sizes[rownames(pc$x)] - mins + 1])
plot(pcx[, 1], go_sizes[rownames(pcx)], pch = 16, col = '#00000080')
plot(pcx[, 1], go_sizes[rownames(pcx)], pch = 16, col = '#00000080', log = 'y')
plot(pcx[, 1], go_sizes[rownames(pcx)],
        col = ifelse(is.na(cat), '#00000040', category_color[cat]),
        pch = 16)
plot(pcx[, 2], go_sizes[rownames(pcx)], pch = 16, col = '#00000080')
```
